        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/**" ,"/swagger-ui/**",
                                "/v3/api-docs/**",
                                "/swagger-ui.html","/api/candidatures/**","/api/affectations/**","/api/campagnes/**","/structures/**","/api/structures/**","/api/documents/**","/api/saisonniers/**","/api/admin/documents-campagne/**","/api/parents/**","/api/**","/api/appels/**").permitAll()
